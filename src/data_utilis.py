...
class InputFeatures(dict):
    ...
    tensorable_keys = ['input_ids', 'inputs_embeds', 'attention_mask', 'token_type_ids', 'label',
        ...
        'past_key_values', 'loss_ids','decoder_label_ids','special_token_ids','weight']
    all_keys = ['input_ids', 'inputs_embeds', 'attention_mask', 'token_type_ids', 'label',
        'decoder_input_ids', 'decoder_inputs_embeds', 'soft_token_ids',
        'past_key_values', 'loss_ids', 'guid', 'tgt_text', 'encoded_tgt_text', 'input_ids_len','decoder_label_ids','answer','special_token_ids',
                'question','answer','context','augment','weight','question_type']
    non_tensorable_keys = []
    ...
    def __init__(self,
                ...
                decoder_label_ids: Optional[Union[List,torch.Tensor]] =None,
                decoder_input_ids: Optional[Union[List, torch.Tensor]] = None,
                decoder_inputs_embeds: Optional[torch.Tensor] = None,
                special_token_ids: Optional[Union[List, torch.Tensor]] = None,
                ...
                answer: Optional[Union[str,list]]=None,
                question: Optional[Union[str, list]] = None,
